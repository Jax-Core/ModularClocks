...
### Setting Up
Use the JaxCore menu to configure the clock's colors, style, fillings and more.
FAQs can be found in the [documentation](https://jaxcore.gitbook.io/core/widgets/modularclocks)
<br>
<br>
## Help and Credits
